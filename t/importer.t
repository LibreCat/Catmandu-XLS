...
my $importer = Catmandu::Importer::XLS->new(file => './t/test.xls', empty => 'ignore');
...
$importer = Catmandu::Importer::XLSX->new(file => './t/test.xlsx', empty => 'ignore');
